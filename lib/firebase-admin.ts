...
function resolveServiceAccount(): any | undefined {
	const key = process.env.FIREBASE_SERVICE_ACCOUNT_KEY;
	const keyB64 = process.env.FIREBASE_SERVICE_ACCOUNT_KEY_BASE64;
	const keyFile = process.env.FIREBASE_SERVICE_ACCOUNT_KEY_FILE || process.env.FIREBASE_SERVICE_ACCOUNT_KEY_PATH || process.env.GOOGLE_APPLICATION_CREDENTIALS;
